...
class ImageTransformTest(testing.FeatureExpectationsTestCase):
  ...
  def test_image_custom_decode(self):
    ...
    class DecodeCrop(transform_lib.image.Decoder):
    ...
    self.assertFeature(
        ...
        tests=[
            ...
            testing.FeatureExpectationItem(
                ...
                shape=(),
                dtype=tf.string,
                decoders=transform_lib.image.SkipDecoding(),
            ),
        ],
    )
  ...
  def test_video_custom_decode(self):
    ...
    self.assertFeature(
        ...
        tests=[
            testing.FeatureExpectationItem(
                decoders={
                    'image': transform_lib.image.SkipDecoding(),
                },
                value={
                    'image': image_path,
                    'label': 123,
